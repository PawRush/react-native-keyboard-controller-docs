...
Your app is deployed to AWS! Preview URL: https://d1mpoowyx4879c.cloudfront.net/react-native-keyboard-controller/index.html
...
aws cloudfront create-invalidation --distribution-id "E3BRNQ9A6SYIHD" --paths "/*"

# View CloudFront access logs (last hour)
aws s3 ls "s3://kbdctrldocsfrontend-previ-cftos3cloudfrontloggingb-jhoo87sibjzr/" --recursive | tail -20
...
Next: Deployment complete and documented
