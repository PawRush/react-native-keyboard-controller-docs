    ...
    return (<header className={(0, clsx_1.default)("hero hero--primary", index_module_css_1.default.heroBanner)}>
      <div className="container">
        ...
        <div className={index_module_css_1.default.buttons}>
          <Link_1.default className="button button--secondary button--lg" to="/docs/installation">
            Get Started
          </Link_1.default>
        </div>
      </div>
...
function TrustedBy() {
    return (<section className={(0, clsx_1.default)(index_module_css_1.default.trustedBySection)}>
      <h2 className={(0, clsx_1.default)(index_module_css_1.default.trustedByTitle)}>Trusted by</h2>
      <div className={(0, clsx_1.default)(index_module_css_1.default.trustedByContainer)}>
        {trustedBy.map(function (item, index) { return (<a key={index} href={item.link} target="_blank">
            <img alt={item.alt} className={(0, clsx_1.default)(index_module_css_1.default.trustedByImg)} src={item.img}/>
            <h4>{item.name}</h4>
          </a>); })}
      </div>
      <p className={(0, clsx_1.default)(index_module_css_1.default.addYourApp)}>
...
function Home() {
    var siteConfig = (0, useDocusaurusContext_1.default)().siteConfig;
    return (<Layout_1.default description={siteConfig.tagline} title={"React Native Keyboard Controller \u00B7 Control each frame of keyboard movement"}>
      <HomepageHeader />
      <main>
