...
export class FrontendStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendStackProps) {
      ...
      cloudFrontDistributionProps: {
        ...
        defaultBehavior: {
          ...
          functionAssociations: [
            ...
            {
              function: new cloudfront.Function(this, "ExtensionRewriteFunction", {
                runtime: cloudfront.FunctionRuntime.JS_2_0,
                code: cloudfront.FunctionCode.fromInline(`
                  function handler(event) {
                ...
                `),
                comment: "Rewrites /path to /path.html for Docusaurus trailingSlash:false",
              }),
    ...
    new s3deploy.BucketDeployment(this, "DeployWebsite", {
      ...
      destinationKeyPrefix: "react-native-keyboard-controller",
      distribution,
      distributionPaths: ["/react-native-keyboard-controller/*"],
      prune: true,
      memoryLimit: 512,
    });
    ...
    new cdk.CfnOutput(this, "WebsiteURL", {
      value: `https://${distribution.distributionDomainName}/react-native-keyboard-controller`,
